...
from minLights.rpc import analysis_configuration_pb2 as minknow_dot_rpc_dot_analysis__configuration__pb2
...
class AnalysisConfigurationServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.reset_analysis_configuration = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/reset_analysis_configuration',
        request_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.ResetAnalysisConfigurationRequest.SerializeToString,
        response_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.ResetAnalysisConfigurationResponse.FromString,
        )
    ...
    self.set_basecaller_configuration = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/set_basecaller_configuration',
        request_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetBasecallerConfigurationRequest.SerializeToString,
        response_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetBasecallerConfigurationResponse.FromString,
        )
    self.get_basecaller_configuration = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/get_basecaller_configuration',
        request_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.GetBasecallerConfigurationRequest.SerializeToString,
        response_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.BasecallerConfiguration.FromString,
        )
    self.get_pore_type_configuration = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/get_pore_type_configuration',
        request_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.GetPoreTypeConfigurationRequest.SerializeToString,
        response_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.PoreTypeConfiguration.FromString,
        )
    self.set_pore_type_configuration = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/set_pore_type_configuration',
        request_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.PoreTypeConfiguration.SerializeToString,
        response_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetPoreTypeConfigurationResponse.FromString,
        )
    self.set_writer_configuration = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/set_writer_configuration',
        request_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.WriterConfiguration.SerializeToString,
        response_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetWriterConfigurationResponse.FromString,
        )
    self.get_writer_configuration = channel.unary_unary(
        '/ont.rpc.analysis_configuration.AnalysisConfigurationService/get_writer_configuration',
        request_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.GetWriterConfigurationRequest.SerializeToString,
        response_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.WriterConfiguration.FromString,
        )
...
def add_AnalysisConfigurationServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'reset_analysis_configuration': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.ResetAnalysisConfigurationRequest.FromString,
          response_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.ResetAnalysisConfigurationResponse.SerializeToString,
      ),
      ...
      'set_basecaller_configuration': grpc.unary_unary_rpc_method_handler(
          ...
          request_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetBasecallerConfigurationRequest.FromString,
          response_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetBasecallerConfigurationResponse.SerializeToString,
      ),
      'get_basecaller_configuration': grpc.unary_unary_rpc_method_handler(
          servicer.get_basecaller_configuration,
          request_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.GetBasecallerConfigurationRequest.FromString,
          response_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.BasecallerConfiguration.SerializeToString,
      ),
      'get_pore_type_configuration': grpc.unary_unary_rpc_method_handler(
          servicer.get_pore_type_configuration,
          request_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.GetPoreTypeConfigurationRequest.FromString,
          response_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.PoreTypeConfiguration.SerializeToString,
      ),
      'set_pore_type_configuration': grpc.unary_unary_rpc_method_handler(
          servicer.set_pore_type_configuration,
          request_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.PoreTypeConfiguration.FromString,
          response_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetPoreTypeConfigurationResponse.SerializeToString,
      ),
      'set_writer_configuration': grpc.unary_unary_rpc_method_handler(
          servicer.set_writer_configuration,
          request_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.WriterConfiguration.FromString,
          response_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.SetWriterConfigurationResponse.SerializeToString,
      ),
      'get_writer_configuration': grpc.unary_unary_rpc_method_handler(
          servicer.get_writer_configuration,
          request_deserializer=minknow_dot_rpc_dot_analysis__configuration__pb2.GetWriterConfigurationRequest.FromString,
          response_serializer=minknow_dot_rpc_dot_analysis__configuration__pb2.WriterConfiguration.SerializeToString,
      ),
  }
