...
_WRITEFLOWCELLDATAREQUEST_VERSION5 = _descriptor.Descriptor(
  name='Version5',
  full_name='ont.rpc.production.WriteFlowcellDataRequest.Version5',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='minor_version', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version5.minor_version', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='wells_per_channel', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version5.wells_per_channel', index=1,
      number=2, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temperature_offset', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version5.temperature_offset', index=2,
      number=3, type=17, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='flowcell_id', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version5.flowcell_id', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='product_code', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version5.product_code', index=4,
      number=5, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='temperature_offset_nullable', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version5.temperature_offset_nullable',
      index=0, containing_type=None, fields=[]),
  ],
...
_WRITEFLOWCELLDATAREQUEST_VERSION6 = _descriptor.Descriptor(
  name='Version6',
  full_name='ont.rpc.production.WriteFlowcellDataRequest.Version6',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='minor_version', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version6.minor_version', index=0,
      number=1, type=13, cpp_type=3, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='temperature_offset', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version6.temperature_offset', index=1,
      number=2, type=17, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='adapter_id', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version6.adapter_id', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  oneofs=[
    _descriptor.OneofDescriptor(
      name='temperature_offset_nullable', full_name='ont.rpc.production.WriteFlowcellDataRequest.Version6.temperature_offset_nullable',
      index=0, containing_type=None, fields=[]),
  ],
...
_WRITEFLOWCELLDATAREQUEST = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='v5', full_name='ont.rpc.production.WriteFlowcellDataRequest.v5', index=5,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='v6', full_name='ont.rpc.production.WriteFlowcellDataRequest.v6', index=6,
...
WriteFlowcellDataRequest = _reflection.GeneratedProtocolMessageType('WriteFlowcellDataRequest', (_message.Message,), dict(
  ...
  Empty = _reflection.GeneratedProtocolMessageType('Empty', (_message.Message,), dict(
    ...
    __module__ = 'minLights.rpc.production_pb2'
  ...
  Version5 = _reflection.GeneratedProtocolMessageType('Version5', (_message.Message,), dict(
    DESCRIPTOR = _WRITEFLOWCELLDATAREQUEST_VERSION5,
    __module__ = 'minLights.rpc.production_pb2'
    # @@protoc_insertion_point(class_scope:ont.rpc.production.WriteFlowcellDataRequest.Version5)
    ))
  ,

  Version6 = _reflection.GeneratedProtocolMessageType('Version6', (_message.Message,), dict(
    DESCRIPTOR = _WRITEFLOWCELLDATAREQUEST_VERSION6,
    __module__ = 'minLights.rpc.production_pb2'
    # @@protoc_insertion_point(class_scope:ont.rpc.production.WriteFlowcellDataRequest.Version6)
    ))
  ,
